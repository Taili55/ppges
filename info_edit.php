        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white"  id="navbar-example3" style="max-width: 18rem; float:left; margin-top: 3%; margin-left: 3%; border-radius: none;  "   >
            ...
            <div class="collapse navbar-collapse" id="navbarSupporteContent">
                <nav class="nav flex-column">
                        ...
                        <a class="nav-link" style="background-color:rgba(185, 182, 182, 0.42) ; color:  #000;"  href="info_edit.php">Informes</a>
            ...
            <div class="container" style="max-width: 72.5%;  margin-left: 25.7%; padding-top: 2%; margin-bottom: 3%;" > 
                <table class="table table-hover" >
                    <thead>
                        ...
                        <th>Opções </th>
                        <th> 
                            <button type="button"   class="btn btn-success" data-toggle="modal" data-target="#confirm"><span class="oi oi-plus"> </span>  Adicionar</button> 
                            <div class="modal fade" id="confirm" role="dialog ">
                                <div class="modal-dialog modal-lg ">
                                    <div class="modal-content ">
                                        <div class="modal-body">
                                            <form method="POST" action="php/result_info.php">
                                                <div class="form-group">                    
                                                    <label><b>Título: </b></label>
                                                    <input type="text" style="width:95%" name="titulo" placeholder="Digite o título do trabalho" class="form-control">
                                                    
                                                    <label><b>Data: </b></label>
                                                    <input type="date" style="width:95%" name="data" class="form-control">
                                                    ...
                                                    <input type="file" accept="application/pdf" name="download" style="width:95%"  class="form-control">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>  
                                <button type="button"  class="btn btn-success" data-toggle="modal" data-target="#confirm<?php echo $rows_Home['idinformes']; ?>"><span class="oi oi-pencil"></span></button> 
                                                
                                <div class="modal fade" id="confirm<?php echo $rows_Home['idinformes']; ?>" role="dialog ">
                                    <div class="modal-dialog ">
                                        <div class="modal-content modal-lg">
                                            <div class="modal-body">
                                                <form method="POST" action="php/edit_Info.php">
                                                    <div class="form-group">
                                                        <label><b>Título: </b></label>
                                                        <input type="text" style="width:95%" name="titulo" placeholder="Digite o nome do Professor" value= "<?php echo $rows_Home['titulo']; ?>" class="form-control">
                                                        
                                                        <label><b>Data: </b></label>
                                                        <input type="date" style="width:95%" name="titulo" placeholder="Digite o nome do Professor" value= "<?php echo $rows_Home['data']; ?>" class="form-control">
                                                    
                                                        <label><b>Descrição: </b></label>
                                                        <textarea type="text"  name="descricao"  style="width:95%" placeholder="Digite a Área" value= "<?php echo $rows_Home['descricao']; ?>"class="form-control"> </textarea>
                                                    
                                                        
                                                    
                                                        <label><b>Download: </b></label>
                                                        <input type="file" accept="application/pdf" name="download" placeholder="Digite o nome do Professor" class="form-control">
                                                    </div>
                                        
                                                    <br><br>
                                                    <center>
                                                        <input type="hidden" name="idinformes" value="<?php echo $rows_Home['idinformes']; ?>">
                                ...
                                <button type="button"  class="btn btn-default " data-toggle="modal" data-target="#confirma<?php echo $rows_Home['idinformes']; ?>"><span class="oi oi-spreadsheet"></span></button> 
                                                
                                <div class="modal fade" id="confirma<?php echo $rows_Home['idinformes']; ?>" role="dialog ">
                                    <div class="modal-dialog ">
                                        <div class="modal-content modal-lg">
                                            <div class="modal-body">
                                                <h4>Título: </h4>
                                                ...
                                                <h4>Download: </h4>
                                                <p><a href="PDF/<?php echo $rows_Home['download']; ?>"><?php echo $rows_Home['titulo']; ?></a></p>
                                                <br><br>
                                                <center>
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#confirme<?php echo $rows_Home['idinformes']; ?>  "><span class="oi oi-trash" ></span> </button>
                                <div class="modal fade" id="confirme<?php echo $rows_Home['idinformes']; ?>" role="dialog">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger btn-sm"><a href="php/excluir_info.php?idinformes=<?php echo $rows_Home['idinformes']; ?>" style="color:white"  >  Excluir</a></button>
                                                <button type="button" data-dismiss="modal" class="btn btn-default">Cancelar</button>
                                            </div>
                                        </div>
                                    </div>
