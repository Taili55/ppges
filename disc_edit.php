        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white"  id="navbar-example3" style="max-width: 18rem; float:left; margin-top: 3%; margin-left: 3%; border-radius: none;  "   >
            ...
            <div class="collapse navbar-collapse" id="navbarSupporteContent">
                <nav class="nav flex-column">
                        ...
                        <a class="nav-link" style="background-color:rgba(185, 182, 182, 0.42) ; color:  #000;"  href="disc_edit.php">Disciplinas do Mestrado</a>
            ...
            <div class="container" style="max-width: 72.5%;  margin-left: 25.7%; padding-top: 2%; margin-bottom: 3%;" > 
                <table class="table table-hover" >
                                ...
                                <div class="modal-dialog modal-lg ">
                                    <div class="modal-content ">
                                        <div class="modal-body">
                                            <form method="POST" action="php/result_disci.php">
                                                <div class="form-group">                                                                        
                                                    <label><b>Código: </b></label>
                                                    <input type="text" name="codigo" placeholder="Digite o Código da Displina" class="form-control">
                                                    
                                                    <label><b>Nome: </b></label>
                                                    <input type="text"  name="nome" placeholder="Digite o nome da Displina" class="form-control">
                                                    
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <label><b>Obrigatoriedade: </b></label>
                                                            <select name="obrig"  class="form-control selectpicker" >
                                                                <option> ... </option>
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <select name="credito"  class="form-control selectpicker" >
                                                                <option value= "-"> - </option>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $rows_Home['codigo'];?></td>
                            <td><?php echo mb_strimwidth($rows_Home['nome'], 0, 60,"...");?></td>
                            <td>  
                                <button type="button"  class="btn btn-success" data-toggle="modal" data-target="#confirm<?php echo $rows_Home['iddisci']; ?>"><span class="oi oi-pencil"></span></button> 
                                                
                                <div class="modal fade" id="confirm<?php echo $rows_Home['iddisci']; ?>" role="dialog ">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content modal-lg">
                                            <div class="modal-body">
                                                <form method="POST" action="php/edit_Disci.php">
                                                    <div class="form-group">
                                                        <label><b>Código: </b></label>
                                                        <input type="text"  value="<?php echo $rows_Home['codigo']; ?>" name="codigo"  placeholder="Digite o nome da Displina" class="form-control">
                                                        
                                                        <label><b>Nome: </b></label>
                                                        <input type="text" name="nome" value="<?php echo $rows_Home['nome']; ?>"  placeholder="Digite o Código da Discipina" class="form-control">
                                                        ...
                                                        <div class="col">
                                                            <label><b>Créditos: </b></label>
                                                            <select name="credito" style="width:98%"  class="form-control selectpicker" >
                                                                <option value= "-"> - </option>
                                                                <option value= "1"> 1</option>
                                                                <option value= "2"> 2 </option>
                                                                <option value= "4"> 4 </option>
                                                    ...
                                                    <br><br>
                                                    <center>
                                                        <input type="hidden" name="iddisci" value="<?php echo $rows_Home['iddisci']; ?>">
                                ...
                                <button type="button"  class="btn btn-default " data-toggle="modal" data-target="#confirma<?php echo $rows_Home['iddisci']; ?>"><span class="oi oi-spreadsheet"></span></button> 
                                                
                                <div class="modal fade" id="confirma<?php echo $rows_Home['iddisci']; ?>" role="dialog ">
                                    <div class="modal-dialog ">
                                        <div class="modal-content modal-lg">
                                            <div class="modal-body">
                                                <h4>Código: </h4>
                                                <p><?php echo $rows_Home['codigo']; ?></p> 
                                                <h4>Nome: </h4>
                                                <p><?php echo $rows_Home['nome']; ?></p>      
                                                <h4>Obrigatoriedade: </h4>
                                                <p><?php echo $rows_Home['obrig']; ?></p>
                                                <h4>Carga Horária: </h4>
                                                <p><?php echo $rows_Home['ch']; ?></p>
                                                <h4>Créditos: </h4>
                                                <p><?php echo $rows_Home['credito']; ?></p>
                                                <br><br>
                                                <center>
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#confirme<?php echo $rows_Home['iddisci']; ?>  "><span class="oi oi-trash" ></span> </button>
                                <div class="modal fade" id="confirme<?php echo $rows_Home['iddisci']; ?>" role="dialog">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger btn-sm"><a href="php/excluir_disci.php?iddisci=<?php echo $rows_Home['iddisci']; ?>" style="color:white"  >  Excluir</a></button>
                                                <button type="button" data-dismiss="modal" class="btn btn-default">Cancelar</button>
                                            </div>
                                        </div>
                                    </div>
