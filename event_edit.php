        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white"  id="navbar-example3" style="max-width: 18rem; float:left; margin-top: 3%; margin-left: 3%; border-radius: none;  "   >
            ...
            <div class="collapse navbar-collapse" id="navbarSupporteContent">
                <nav class="nav flex-column">
                        ...
                        <a class="nav-link" style="background-color:rgba(185, 182, 182, 0.42) ; color:  #000;"  href="event_edit.php">Eventos</a>
                                ...
                                <div class="modal-dialog modal-lg ">
                                    <div class="modal-content ">
                                        <div class="modal-body">
                                            <form method="POST" action="php/result_event.php">
                                                <div class="form-group">                                            
                                                    <label><b>Nome: </b></label>
                                                    <input type="text"  name="nome" placeholder="Digite o nome do Evento" class="form-control">
                                                    
                                                    <label><b>Categoria: </b></label>
                                                    <select name="categoria"   class="form-control selectpicker" >
                                                        <option value= "-"> - </option>
                                                        <option value= "Evento Regional"> Evento Regional</option>
                                                        <option value= "Evento Nacional"> Evento Nacional</option>
                                                        <option value= "Evento Internacional"> Evento Internacional </option>
                                                            <br>
                                                    </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" name="descricao" id="apresentacao" placeholder="Digite a descrição" class="form-control" name="tx_mensagem"class="formbutton" id="tx_mensagem"></textarea>	
                                                        <script>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                <button type="button"  class="btn btn-success" data-toggle="modal" data-target="#confirm<?php echo $rows_Home['idevento']; ?>"><span class="oi oi-pencil"></span></button> 
                                                
                                <div class="modal fade" id="confirm<?php echo $rows_Home['idevento']; ?>" role="dialog ">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content modal-lg">
                                            <div class="modal-body">
                                                <form method="POST" action="php/edit_eve.php">
                                                    <div class="form-group">
                                                        
                                    

                                                        <label><b>Nome: </b></label>
                                                        <input type="text"  name="nome" placeholder="Digite o nome do Evento" value="<?php echo $rows_Home['nome'];?>" class="form-control">
                                                    ...
                                                    <div class="form-group">
                                                        <label><b>Descrição: </b></label>
                                                        <textarea type="text" name="descricao" id="apresentacao" placeholder="Digite a descrição" class="form-control" name="tx_mensagem"class="formbutton" id="tx_mensagem"><?php echo $rows_Home['descricao']; ?>"</textarea>	
                                                        <script>
                                                            CKEDITOR.replace( 'descricao' );
                                                        </script>
                                                    ...
                                                    <br><br>
                                                    <center>
                                                        <input type="hidden" name="idevento" value="<?php echo $rows_Home['idevento']; ?>">
                                ...
                                <button type="button"  class="btn btn-default " data-toggle="modal" data-target="#confirma<?php echo $rows_Home['idevento']; ?>"><span class="oi oi-spreadsheet"></span></button> 
                                                
                                <div class="modal fade" id="confirma<?php echo $rows_Home['idevento']; ?>" role="dialog ">
                                    <div class="modal-dialog ">
                                        <div class="modal-content modal-lg">
                                            <div class="modal-body">
                                                ...
                                                <h4>Categoria: </h4>
                                                <p><?php echo $rows_Home['categoria']; ?></p>      
                                                <h4>Data: </h4>
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#confirme<?php echo $rows_Home['idevento']; ?>  "><span class="oi oi-trash" ></span> </button>
                                <div class="modal fade" id="confirme<?php echo $rows_Home['idevento']; ?>" role="dialog">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger btn-sm"><a href="php/excluir_eve.php?idevento=<?php echo $rows_Home['idevento']; ?>" style="color:white"  >  Excluir</a></button>
                                                <button type="button" data-dismiss="modal" class="btn btn-default">Cancelar</button>
                                            </div>
                                        </div>
                                    </div>
