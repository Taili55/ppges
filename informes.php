    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white"  id="navbar-example3" style="max-width: 18rem; float:left; margin-top: 3%; margin-left: 3%; border-radius: none;  "   >
            ...
            <div class="collapse navbar-collapse" id="navbarSupporteContent">
                <nav class="nav flex-column">
                        ...
                        <a class="nav-link" style="color:  #000;"  href="coord.php">Coordenação</a>
        ...
        <div data-spy="scroll" data-target="#navbar-example3" data-offset="0">
            <div class="container" style="max-width: 72.5%;  margin-left: 25.7%; padding-top: 2%; margin-bottom: 3%;" >
                ...
                <h3> <?php echo $rows_obj['titulo'];?> </h3>
                <p style="font-size: 14px; "> <span class="oi oi-calendar" aria-hidden="true"></span>  <?php echo $rows_obj['data'];?>  </p>
                <p style="font-size: 14px; "><?php echo $rows_obj['descricao'];?>  </p>
                <a class="nav-link" style="color:  #2d842d;" href=" <?php echo $rows_obj['download'];?> "> <?php echo $rows_obj['titulo'];?> </a>
            <hr>
               <?php }?>
            </div>  
        </div>
